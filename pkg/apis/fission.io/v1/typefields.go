...
type (
	...
	*/
	...
	FunctionReference struct {
		...
		// this field will be updated as a label to all functions that are backends for canary deployment
		// for this trigger
		// this will be generated by fission cli at the time of trigger create and is immutable during update.
		CanaryLabel string
	}
